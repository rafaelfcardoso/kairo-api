...
export class AddIsGoalToTagTable1741607800000 implements MigrationInterface {
  name = 'AddIsGoalToTagTable1741607800000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (columnExists) {
      // Drop the isGoal column if it exists
